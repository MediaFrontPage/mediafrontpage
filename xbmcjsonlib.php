...
$xbmcJsonMethods = array(
		...
		'Player.PlayPause' => array(
			'call' => '{"jsonrpc": "2.0", "method": "Player.PlayPause", "params": { "playerid": %d}, "id": 1}',
			'args' => array(
				'playerid' => ''
			)
		),
		'Player.GoPrevious' => array(
			'call' => '{"jsonrpc": "2.0", "method": "Player.GoPrevious", "params": { "playerid": %d}, "id": 1}',
			'args' => array(
				'playerid' => ''
			)
		),
		'Player.GoNext'				=> array('call' => '{"jsonrpc": "2.0", "method": "Player.GoNext", "params": { "playerid": %d}, "id": 1}',
		'args' => array(
				'playerid' => ''
			)
		),
		'Player.Stop'				=> array('call' => '{"jsonrpc": "2.0", "method": "Player.Stop", "params": { "playerid": %d}, "id": 1}',
		'args' => array(
				'playerid' => ''
			)
		),
		...
		'AudioLibraryV3.GetArtists' => array(
			'call' => '{"jsonrpc": "2.0", "method": "AudioLibrary.GetArtists", "params": { "properties" : ["instrument", "style", "mood", "born", "formed", "description", "genre", "died", "disbanded", "yearsactive", "musicbrainzartistid", "fanart", "thumbnail" ]}, "id": 1}',
			'sql' => array(
				'db' => 'music',
				'query' => 'select * from artist where (idArtist IN (select song.idArtist from song) or idArtist IN (select exartistsong.idArtist from exartistsong) or idArtist IN (select album.idArtist from album) or idArtist IN (select exartistalbum.idArtist from exartistalbum ))  and artist.strArtist != "" and artist.idArtist<>1',
				'resultwrapper' => 'artists'
		...
		'AudioLibraryV3.GetAlbums' => array(
			'call' => '{"jsonrpc": "2.0", "method": "AudioLibrary.GetAlbums", "params": { "artistid" : %d, "properties" : [ "title", "description", "artist", "genre", "theme", "mood", "style", "type", "albumlabel", "rating", "year", "musicbrainzalbumid", "musicbrainzalbumartistid", "fanart", "thumbnail", "artistid" ] },"id": 1}',
			'args' => array(
				'artistid' => ''
			),
		),
		'AudioLibraryV3NoArtist.GetAlbums' => array(
			'call' => '{"jsonrpc": "2.0", "method": "AudioLibrary.GetAlbums", "params": { "properties" : [ "title", "description", "artist", "genre", "theme", "mood", "style", "type", "albumlabel", "rating", "year", "musicbrainzalbumid", "musicbrainzalbumartistid", "fanart", "thumbnail", "artistid" ] },"id": 1}',
			'args' => array(
				'artistid' => ''
			),
		),
		...
		'AudioLibraryV3.GetSongs' => array(
			'call' => '{"jsonrpc": "2.0", "method": "AudioLibrary.GetSongs", "params": { "albumid" : %d, "properties" : ["title", "artist", "albumartist", "genre", "year", "rating", "album", "track", "duration", "comment", "lyrics", "musicbrainztrackid", "musicbrainzartistid", "musicbrainzalbumid", "musicbrainzalbumartistid", "playcount", "fanart", "thumbnail", "file", "artistid", "albumid"] },"id": 1}',
			'args' => array(
				'albumid' => ''
			)
		),
		'AudioLibraryV3NoAlbumID.GetSongs' => array(
			'call' => '{"jsonrpc": "2.0", "method": "AudioLibrary.GetSongs", "params": { "properties" : ["title", "artist", "albumartist", "genre", "year", "rating", "album", "track", "duration", "comment", "lyrics", "musicbrainztrackid", "musicbrainzartistid", "musicbrainzalbumid", "musicbrainzalbumartistid", "playcount", "fanart", "thumbnail", "file", "artistid", "albumid"] },"id": 1}',
		),
		...
		'Player.GetProperties' => array(
			'call' => '{"jsonrpc": "2.0", "method": "Player.GetProperties", "params": { "playerid": %d, "properties" : ["type", "partymode", "speed", "time", "percentage", "totaltime", "playlistid", "position", "repeat", "shuffled", "canseek", "canchangespeed", "canmove", "canzoom", "canrotate", "canshuffle", "canrepeat", "currentaudiostream", "audiostreams", "subtitleenabled", "currentsubtitle", "subtitles"]}, "id": 1}',
			'args' => array(
				'playerid' => ''
			)
		),
		'Player.GetItem' => array(
			'call' => '{"jsonrpc": "2.0", "method": "Player.GetItem", "params": { "playerid": %d, "properties" : [ "title", "artist", "albumartist", "genre", "year", "rating", "album", "track", "duration", "comment", "lyrics", "musicbrainztrackid", "musicbrainzartistid", "musicbrainzalbumid", "musicbrainzalbumartistid", "playcount", "fanart", "director", "trailer", "tagline", "plot", "plotoutline", "originaltitle", "lastplayed", "writer", "studio", "mpaa", "cast", "country", "imdbnumber", "premiered", "productioncode", "runtime", "set", "showlink", "streamdetails", "top250", "votes", "firstaired", "season", "episode", "showtitle", "thumbnail", "file", "resume", "artistid", "albumid", "tvshowid", "setid" ]}, "id": 1}',
			'args' => array(
				'playerid' => ''
			)
		),
		'Playlist.GetItems' => array(
			'call' => '{"jsonrpc": "2.0", "method": "Playlist.GetItems", "params": { "playlistid": %d}, "id": 1}',
			'args' => array(
				'playlistid' => ''
			)
		),
		...
		'VideoLibraryV3.GetMovies' => array(
			'call' => '{"jsonrpc": "2.0", "method": "VideoLibrary.GetMovies", "params": { "properties" : ["title", "genre", "year", "rating", "director", "trailer", "tagline", "plot", "plotoutline", "originaltitle", "lastplayed", "playcount", "writer", "studio", "mpaa", "cast", "country", "imdbnumber", "premiered", "productioncode", "runtime", "set", "showlink", "streamdetails", "top250", "votes", "fanart", "thumbnail", "file", "sorttitle", "resume", "setid"] }, "id": 1}'
		),
		...
		'VideoLibraryV3.GetRecentlyAddedEpisodes' => array(
			'call' => '{"jsonrpc": "2.0", "method": "VideoLibrary.GetRecentlyAddedEpisodes", "params" : { "properties" : ["title", "plot", "votes", "rating", "writer", "firstaired", "playcount", "runtime", "director", "productioncode", "season", "episode", "originaltitle", "showtitle", "cast", "streamdetails", "lastplayed", "fanart", "thumbnail", "file", "resume", "tvshowid" ] }, "id" : 1 }',
			'sql' => array(
				'db' => 'video',
				'query' => 'select c13 as episode, idEpisode as episodeid, c05 as firstaired, c00 as label, mpaa, c01 as plot, premiered, strTitle as showtitle, strStudio as studio, c00 as title, * from episodeview order by idEpisode desc limit %d',
				'resultwrapper' => 'episodes'
		...
		'VideoLibraryV3.GetEpisodes' => array(
			'call' => '{"jsonrpc": "2.0", "method": "VideoLibrary.GetEpisodes", "params" : { "tvshowid" : %d, "season" : %d, "properties" : [ "title", "plot", "votes", "rating", "writer", "firstaired", "playcount", "runtime", "director", "productioncode", "season", "episode", "originaltitle", "showtitle", "cast", "streamdetails", "lastplayed", "fanart", "thumbnail", "file", "resume", "tvshowid" ] }, "id" : 1 }',
			'args' => array(
				'tvshowid' => 1,
				'season' => 1
			)
		),
		'VideoLibrary.GetEpisodeDetails' => array(
			'call' => '{"jsonrpc": "2.0", "method": "VideoLibrary.GetEpisodeDetails", "params" : { "tvshowid" : %d, "season" : %d, "fields": [ "title", "plot", "votes", "rating", "writingcredits", "firstaired", "playcount", "runtime", "director", "productioncode", "season", "episode", "originaltitle", "showtitle", "cast", "streamDetails", "lastplayed", "fanart", "thumbnail", "file" ] }, "id" : 1 }',
			'args' => array(
				'tvshowid' => 1,
				'season' => 1
			)
		),
		'VideoLibrary.GetEpisodeDetailsV3' => array(
			'call' => '{"jsonrpc": "2.0", "method": "VideoLibrary.GetEpisodeDetails", "params": { "episodeid": %d, "properties" : ["title", "plot", "votes", "rating", "writer", "firstaired", "playcount", "runtime", "director", "productioncode", "season", "episode", "originaltitle", "showtitle", "cast", "streamdetails", "lastplayed", "fanart", "thumbnail", "file", "resume", "tvshowid" ]}, "id": 1}',
			'args' => array(
				'episodeid' => 1
			)
		),
		'VideoLibrary.GetMovieDetailsV3' => array(
			'call' => '{"jsonrpc": "2.0", "method": "VideoLibrary.GetMovieDetails", "params": { "movieid": %d, "properties" : ["title", "genre", "year", "rating", "director", "trailer", "tagline", "plot", "plotoutline", "originaltitle", "lastplayed", "playcount", "writer", "studio", "mpaa", "cast", "country", "imdbnumber", "premiered", "productioncode", "runtime", "set", "showlink", "streamdetails", "top250", "votes", "fanart", "thumbnail", "file", "sorttitle", "resume", "setid" ]}, "id": 1}',
			'args' => array(
				'movieid' => 1
			)
		),
		...
		'VideoLibraryV3.GetSeasons' => array(
			'call' => '{"jsonrpc": "2.0", "method": "VideoLibrary.GetSeasons", "params" : { "tvshowid" : %d, "properties" : [ "season", "showtitle", "playcount", "episode", "fanart", "thumbnail", "tvshowid" ] }, "id" : 1 }',
			'sql' => array(
				'db' => 'video',
				'query' => 'select episode.c12,path.strPath,tvshow.c00,tvshow.c08,tvshow.c14,tvshow.c13,count(1),count(files.playCount) from episode join tvshowlinkepisode on tvshowlinkepisode.idEpisode=episode.idEpisode join tvshow on tvshow.idShow=tvshowlinkepisode.idShow join files on files.idFile=episode.idFile join tvshowlinkpath on tvshowlinkpath.idShow = tvshow.idShow join path on path.idPath = tvshowlinkpath.idPath where tvshow.idShow = %d group by episode.c12 LIMIT 0, 30',
				'resultwrapper' => 'seasons'
		...
		'VideoPlaylist.GetItems' => array(
			'call' => '{"jsonrpc": "2.0", "method": "VideoPlaylist.GetItems", "params": { "fields": ["tagline", "director", "title", "year", "season", "episode", "plot", "duration", "showtitle"] }, "id": 1}'
		),
